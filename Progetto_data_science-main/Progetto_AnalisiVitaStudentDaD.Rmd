...
Dove ciasun utente si autovaluta in base al proprio valutazione,in 5 livelli diversi che sono :<br>
-fortemente disacordo,<br>
-debolmente disacordo,<br>
-tra disacordo e accordo,<br>
...
<h4>
La tabella riportato sotto in esempio sono cosi come è quello estratto direttamente dal dataset senza nessun manipolazione.<br>
In ogni riga ci sono diversi utenti e per ogni colonna ci sono diversi emozioni ed sentimenti durante l'esperienza della ditatica a distanza.<br>
Dove ciasun utente si autovaluta in base al proprio sentimento,in 5 livelli diversi : 1 il più basso fino 5 il più alto .<br>
</h4>

<br>

Esempio di colonne di dataset per le domande di sentimento per la ditadica a distanza:
```{r ,echo= FALSE}
...
-il confronto :se sei uno che ende di andare in fallimenti con altri<br>
-il confronto :se sei energetico<br>
-il confronto :se sei preocupato tanto<br>
...
<br>
Preparazione il graffico a barre:
```{r,message=FALSE,warning=FALSE,out.width="100%"}
...
Un esempio per il confronto per l'esperienza di ditatica a distanza:
```{r,message=FALSE,warning=FALSE,out.width="100%"}
...
I 2 grafici sotto riportato sono le diferenze per le 20 domande di solitudine nel periodo pre covid e post covid.
...
#manipolazione della tabella di solitudine
 ...
 #persone prima dell'esperienza come valutano per eventuali requesiti
  ...
  div(id = "one", class = "half-fill",
    "Ldsdsadasdsadsdasdasdsdasdas"
  ),
  div(id = "two", class = "half-fill",
    "Rigdasdasdsadsadasdasasdasaf"
  ),
  padding = 10
)
```
...
Da questi analisi si nota che sono scesci in generare 
 <br><br><br>
